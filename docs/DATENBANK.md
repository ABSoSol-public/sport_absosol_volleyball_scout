...
Stand: Version 1.0 (2026-07-27). Ziel-DB: **MariaDB 11** (Charset utf8mb4);
die Tests laufen gegen SQLite in-memory, das Schema ist auf beides portabel.
...
- **Synology**: Zugangsdaten liegen in der git-ignorierten `.env`
  (`SYNOLOGY_DB_*`); Host/Port/DB-Name sind vor dem Deployment zu verifizieren,
